...
**NEW** - Started making docs. Plus, added 3D models, KiCAD files, and media. 

**STATE as of 2/25/24** - Breadboard and prototyping has been completed. Both the first draft of the schematics and the PCBs are completed, with PCBs ordered and arriving soon. 
...
Currently, StratoSoar is not available to buy online as a kit or complete product. We have plans in the next few years to release a kit for schools, education centers, hobbyists and a complete product for industry at an affordable price. You are welcome to make one.
...
If you don't want to wait, you can order all the parts for the PCB from the BOM, order the PCB from JLCPCB using the gerbers, and 3D print all the parts according to the 3D files. You would then have to order carbon fiber rods, and cut them to size. Finally, you would have to be comfortable with SMD soldering according to the PCB files. 
